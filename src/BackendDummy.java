...
public class BackendDummy implements BackendInterface {
	...
	System.out.println("Dummy backend; will ignore average rating to add (" + rating + ")");
    }
	...
	System.out.println("Dummy backend; will ignore average rating to remove (" + rating + ")");
    }
    ...
    public List<String> getAvgRatings() {
        return Arrays.asList(new String [] { "3", "5", "8" });
    }
	...
	movies.add(new MovieInterface() {
	    ...
	    @Override
	    public String getDirector() {
		return "Annie Silverstein";
	    }

	    @Override
	    public String getDescription() {
		return "In a near-abandoned subdivision west of Houston, a wayward teen runs headlong into her equally willful and unforgiving neighbor...";
	    }
	...
	movies.add(new MovieInterface() {
	    ...
	    @Override
	    public String getDescription() {
		return "During a power outage, two strangers tell scary stories....";
	    }
